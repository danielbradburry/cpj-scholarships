...
export class ConstantsService {
  ...
  httpRegExp = /^(https?:\/\/)([\da-zA-Z\.-]+)\.([a-zA-Z\.]{2,7})([\/\w?&~= \.-]*)*\/?$/;
  phoneRegExp = /^([0-9]{10})$/;
  ssnRegExp = /^([0-9]{9})$/;
  zipcodeRegExp = /^([0-9]{5})$/;
  urlFragmentRegExp = /^[a-zA-Z0-9_-]{3,100}$/;

  noUserImage = 'https://d1nt1hxve4jn1b.cloudfront.net/default-images/users/no-image.jpg';
  noChapterLogo = 'https://d1nt1hxve4jn1b.cloudfront.net/default-images/chapters/no-logo.jpg';
